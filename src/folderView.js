...
export async function renderFolderView(items, path, request) {
  ...
  const intro = `<div class="intro markdown-body" style="text-align: left; margin-top: 2rem;">
                    <h2>Planet Cloud OneDrive Index</h2>
                    <p><a href="https://planet-cloud.fun">Planet Cloud</a> · <a href="https://github.com/HEIGE-PCloud">GitHub</a> · <a href="https://status.planet-cloud.fun">Service Status</a></p>
                  </div>`
